...
public class FederatedDatacenter extends CloudSimEntity implements Datacenter {
     ...
     */
    public FederatedDatacenter(final Simulation simulation, final List<? extends Host> hostList,final FederationMember owner) {
        this(simulation, hostList, new VmAllocationPolicySimple(), new DatacenterStorage(), owner);
    }
    ...
    public FederatedDatacenter(
        ...
        final FederationMember owner)
    {
        this(simulation, hostList, vmAllocationPolicy, new DatacenterStorage(storageList), owner);
    }
    ...
    public boolean equals(final Object object) {
        ...
        final FederatedDatacenter that = (FederatedDatacenter) object;
