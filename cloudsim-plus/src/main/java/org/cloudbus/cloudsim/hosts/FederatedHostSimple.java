...
import org.cloudbus.cloudsim.schedulers.vm.FederatedVmSchedulerSpaceShared;
 ...
 */
public class FederatedHostSimple implements Host {
     ...
     */
    public FederatedHostSimple(final List<Pe> peList) {
        this(peList, true);
    }
     ...
     * @see #setDefaultStorageCapacity(long)
     */
    public FederatedHostSimple(final List<Pe> peList, final boolean activate) {
     ...
     * @see #setVmScheduler(VmScheduler)
     */
    public FederatedHostSimple(final long ram, final long bw, final long storage, final List<Pe> peList) {
        this(ram, bw, new HarddriveStorage(storage), peList);
    }

    public FederatedHostSimple(final long ram, final long bw, final HarddriveStorage storage, final List<Pe> peList) {
     ...
     * @see #setVmScheduler(VmScheduler)
     */
    public FederatedHostSimple(final long ram, final long bw, final long storage, final List<Pe> peList, final boolean activate) {
        this(ram, bw, new HarddriveStorage(storage), peList, activate);
    }

    private FederatedHostSimple(final long ram, final long bw, final HarddriveStorage storage, final List<Pe> peList, final boolean activate) {
        this.setId(-1);
        ...
        this.setVmScheduler(new FederatedVmSchedulerSpaceShared());
    ...
    public void processActivation(final boolean activate) {
        ...
        ((FederatedDatacenter) datacenter).updateActiveHostsNumber(this);
    ...
    public boolean equals(final Object obj) {
        ...
        final FederatedHostSimple that = (FederatedHostSimple) obj;
