 ...
 */
public abstract class FederatedVmSchedulerAbstract implements VmScheduler {
    /**
     ...
     */
    public FederatedVmSchedulerAbstract(final double vmMigrationCpuOverhead){
    ...
    private void updateStatusOfHostPesUsedByVm(final List<Pe> peList, final Pe.Status newStatus, final long vPesNumber) {
        ...
        ((FederatedHostSimple)host).setPeStatus(selectedPes, newStatus);
    }
