 ...
 */
public class FederatedVmSchedulerSpaceShared extends FederatedVmSchedulerAbstract {

    /**
     * Creates a space-shared VM scheduler.
     *
     */
    public FederatedVmSchedulerSpaceShared() {
     ...
     */
    public FederatedVmSchedulerSpaceShared(final double vmMigrationCpuOverhead){
