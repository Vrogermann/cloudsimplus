 ...
 */
public class FederatedHostHistoryTableBuilder extends TableBuilderAbstract<HostStateHistoryEntry>{
     ...
     */
    public FederatedHostHistoryTableBuilder(final Host host) {
